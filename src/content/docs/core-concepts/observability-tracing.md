...
| W3C header | Subprocess env var | Notes |
|---|---|---|
| `traceparent` | `TRACEPARENT` | OTel SDKs auto-extract on startup |
| `tracestate` | `TRACESTATE` | Propagated when non-empty |
| `baggage` | `BAGGAGE` | Application-level identifiers |
